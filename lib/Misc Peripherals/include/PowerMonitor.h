...
class PowerMonitor {
  /**
   * @brief Handles all computation regarding current and voltage and computes
   * its power. The loop() function must be called in the main loop
   */
public:
  /**
   ...
   */
  PowerMonitor(const uint32_t currentPin, const uint32_t voltagePin,
