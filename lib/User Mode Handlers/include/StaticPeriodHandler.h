...
/**
 * @brief StaticPeriodHandler is used to interpet the user mode sequence for a
 * static period sequence in which all the data points are spread out equally
 *
 */
...
public:
   ...
   */
  StaticPeriodHandler(LEDDriver *driver, uint8_t *bufferIn,
  ...
  /**
   * @brief the sofware timed loop controlling the sequence, must be called as
   * quickly as possible
   *
   */
  void loop() final;
