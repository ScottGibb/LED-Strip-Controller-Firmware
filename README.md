...
![Firmware Class Diagram](docs/Diagrams-Firmware%20Class%20Diagram.png)

The firmware is split into multiple layers which follow this layer convention:

![Firmware Abstraction Layers](docs/Diagrams-Firmware%20Abstraction%20Layers.png)
